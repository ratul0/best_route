...
public class RouteController {
    ...
    public ResponseEntity<RouteDto> fastestRoute(@PathVariable("from") Ports from, @PathVariable("to") Ports to) {
        return ResponseEntity.ok().body(this.routeService.getFastestRoute(from.name(), to.name()));
    }
    ...
    public ResponseEntity<RouteDto> safestRoute(@PathVariable("from") Ports from, @PathVariable("to") Ports to) {
        return ResponseEntity.ok().body(this.routeService.getSafestRoute(from.name(), to.name()));
    }
